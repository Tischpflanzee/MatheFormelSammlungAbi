...
\begin{spacing}{\Zeilenabstand}
    ...
    Zum Beispiel Die Punkte:$A({\color{green}-2} | {\color{purple}- 18})$,$B({\color{blue}1}|{\color{red}-3})$,$C({\color{pink}4}|{\color{cyan}-24})$ gegeben sind dann:

    A:\@ ${\color{purple}-18} = a \cdot ({\color{green}-2})^2 +b \cdot ({\color{green}-2}) + c $

    B:\@ ${\color{red}-3} = a \cdot ({\color{blue}1})^2 +b \cdot ({\color{blue}1}) + c $

    C:\@ ${\color{cyan}-24} = a \cdot ({\color{pink}4})^2 +b \cdot ({\color{pink}4}) + c$
    ...
    \begin{tabular}{p{5cm} p{5cm} p{5cm}}
        ...
        Schneidet die Gerade die quadratische Funktion in zwei Punkte
    \end{tabular}
    ...
    \begin{equation}
        f(x) = x^3 -x
    \end{equation}
    Man setzte für $x -x$ ein
    \begin{equation}
        f(-x) = (-x)^{3} -(-x) 
    \end{equation}
    \begin{equation}
        \Rightarrow -x^{3} + x = -f(x)
    \end{equation}
    ...
    \begin{equation}
        g(x) = x^4 + x^{4}
    \end{equation}
    Für $x$ wird $-x$ eingesetz
    \begin{equation}
        \Rightarrow g(-x) = (-x)^{4} + (-x)^{2} = x^{4} + x^{2} = g(x) 
    \end{equation}
    ...
    %\newpage
        ...
        \section{Ableitungen von Funktionen}
            \subsection{Wie Leitet man ab}
                \begin{equation}
                    f(x)= ax^{{\color{green}3}}+ax^{{\color{red}2}}+{\color{purple}x}+4 \Rightarrow 3ax^{\color{green}3-1}+2ax^{({\color{red}2-1})}+{\color{purple}x^{0}} \Rightarrow 3ax^{\color{green}2}+2ax^{({\color{red}1})}+{\color{purple}1}
                \end{equation}
    ...
    Um jetzt herrauszufinden ob es ein Hoch oder Tiefpunkt siehe~\ref{6.2}
            ...
            \subsection{Umschreiben Potenzen bsp. ${\sqrt{x}} $}
    ...
    \fbox{\includegraphics[width=5.5cm]{Bilder/image_Funktionen.png}}
    \end{wrapfigure}
    ...
    \subsection{Nutzen von der Zweiten Ableitung}

    \subsubsection{Hoch und Tiefpunkte einer Funktion}
    ...
    \subsubsection{Wendepunkte berrechnen}
    ...
    \section{E-Funktion}
        ...
        \subsection{Eigenschaften}
            ...
            Die Standert E-Funktion hat die eigentschaft das bei (1)
        ...
        \subsection{Ableitung einer E-Funktion}
    ...
    \section{Integrale}
        ...
        \subsection{Potenzregel}
            ...
            \begin{equation}
                f(x)=ax^{n} \Rightarrow F(x)= \frac{a}{n+1} \cdot x^{n+1} + c
            \end{equation}

        \subsection{Summeregel}

            \begin{equation}
                f(x)= g(x) + h(x) \Rightarrow F(x) = G(x) + H(x) + c     
            \end{equation}

            Beispiel:

            \begin{equation}
                f(x) = x^{2} + 3x \Rightarrow F(x)= \frac{1}{3}x^{3}+\frac{3}{2}x^{2} + c
            \end{equation}
            
        \subsection{Faktorregel}

            \begin{equation}
                a\cdot f(x) \Rightarrow (a\cdot F(x))'= a\cdot F'(x)
            \end{equation}
        
        \subsection{Lineare Kettenregel}

            \begin{equation}
                f(x)=f(ax+b)^{n} \Rightarrow F(x)= \frac{1}{a}\cdot \frac{1}{n+1}\cdot F(ax+b)^{n+1} +c 
            \end{equation}

            \textbf{Beispiel:}

            \begin{equation}
                f(x) = (-3x+2)^{4} \Rightarrow F(x)=-\frac{1}{3}\cdot\frac{1}{5}(-3x+2)^{5}+c
            \end{equation}

        \subsection{Cosinus/SinunsRegel}
            
            \begin{equation}
                \sin(x)\Rightarrow-\cos(x)\Rightarrow-\sin\Rightarrow\cos\Rightarrow\sin(x)\Rightarrow\cdots
            \end{equation}
